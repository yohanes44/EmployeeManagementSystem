      ...
      if(err){
          ...
          if(data.length>0){
                ...
                if(data[0].role == "user"){//send to user page
                      ...
                      console.log(data[0]);
                      userInfo = data[0];
                      var copyOfUserData = data[0]; 
                      usersViewOtherEmps(res, copyOfUserData);
...
function usersViewOtherEmps(response, userObj){
                 ...
                 response.write(`<table ng-hide="me" class="table"><thead><tr>`)
                  ...
                  // response.end();
                    ...
                    <li class="nav-item">
                      ...
                      response.write(`<table ng-show="me" class="table"><thead><tr><th scope="col">First Name</th><th scope="col">Last Name</th><th scope="col">Position</th><th scope="col">Salary</th><th scope="col">Phone Number</th><th scope="col">address</tr></thead>`);
                      response.write(`<tbody><tr><td>${userObj.firsetName}</td><td>${userObj.lastName}</td><td>${userObj.position}</td><td>${userObj.salary}</td><td>${userObj.phoneNumber}</td><td>${userObj.address}</td></tr></tbody>`);
                     

                      response.write(`<button ng-click="Mee()">Mee</button><button ng-click="Other()">Other</button>`)     
...
//Update Users Data
                       response.write(`<div ng-show="me">
                   <form action="/updatePerson" method="post" id="form">
                     
                   <div class="mb-2">
                     <input type="text" name="PersonToBeUpdated" class="form-control" value="${userObj.firsetName}" id="PersonToBeUpdated">
                   </div>
                    
                     <div class="mb-2" >
                       <label for="fNameEdit" class="form-label">Edit FirstName</label>
                       <input type="text" name="fNameEdit"  value="${userObj.firsetName}" class="form-control" id="fNameEdit">
                     </div>
                     <div class="mb-1">
                         <label for="lNameEdit" class="form-label">Edit lastName</label>
                         <input type="text" name="lNameEdit" value="${userObj.lastName}" class="form-control" id="lNameEdit">
                     </div>
                     <div class="mb-1">
                         <label for="phoneNumberEdit" class="form-label">Edit phoneNumber</label>
                         <input type="text" name="phoneNumberEdit" value="${userObj.phoneNumber}" class="form-control" id="phoneNumberEdit">
                     </div>
                     <div class="mb-1">
                         <label for="addressEdit" class="form-label">Edit address</label>
                         <input type="text" name="addressEdit" value="${userObj.address}" class="form-control" id="addressEdit">
                     </div>
                     <div class="mb-1">
                         <label for="emailEdit" class="form-label">Edit email</label>
                         <input type="text" name="emailEdit" value="${userObj.email}" class="form-control" id="emailEdit">
                     </div><button id='btnUpdate' type="submit" value="submit" class="btn btn-primary">Update</button></div>
                    </form>`);
         ...
         <div id="nav"></div>
          ...
          <div class="container-fluid">
            ...
            for(var people in result){
                  ...
                  response.write(`<div><form  action="/updateAdmin" method="post">
                  ...
                  <label for="email" class="form">Password</label>
                  <input type="password" name="password" value=${result[people].password} id="password">
            
                  <button type="submit" ng-click=""  class="btn btn-primary" value="submit">Update</button><br>
 
                    
                  </form>`)
                  response.write(`<strong style="color: red">Employee Number${people}</strong>`)
                  response.write(``)
                  response.write(``)
                  response.write(`</div>`)  
